...
const USER_ROLES = {
    ...
    MANAGER: 'manager',     // 관리자 - 점검 불가, QR 조회 가능, 장비/사이트 관리
    ADMIN: 'admin'          // 시스템 관리자 - 모든 권한
};

// 페이지 접근 권한 설정
const PAGE_PERMISSIONS = {
    'inspection.html': [USER_ROLES.INSPECTOR, USER_ROLES.ADMIN], // Manager 제외 - 점검 입력 불가
    'qr-scanner.html': [USER_ROLES.VIEWER, USER_ROLES.INSPECTOR, USER_ROLES.MANAGER, USER_ROLES.ADMIN], // Manager도 QR 조회 가능
